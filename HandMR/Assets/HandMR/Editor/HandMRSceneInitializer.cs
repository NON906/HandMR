...
public class HandMRSceneInitializer
{
    ...
    static void InitProjectForIOS()
    {
        if (!Directory.Exists(Application.dataPath + "/HandMR/SubAssets/HandVR/Plugins/iOS"))
        {
            ...
            download("https://github.com/NON906/HandMR/releases/download/0.3/HandMR_iOS_plugin_for_projects_0.3.unitypackage", Application.dataPath + "/../../downloads/HandMR_iOS_plugin_for_projects_0.3.unitypackage");
            AssetDatabase.ImportPackage(Application.dataPath + "/../../downloads/HandMR_iOS_plugin_for_projects_0.3.unitypackage", false);
        }
    }
