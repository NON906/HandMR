    ...
    public class HandMRSceneInitializer
    {
        ...
        public static void InitProjectForIOS()
        {
            if (!Directory.Exists(Application.dataPath + "/HandMR/SubAssets/HandVR/Plugins/iOS"))
            {
                ...
                download("https://github.com/NON906/HandMR/releases/download/1.0/HandMR_iOS_plugin_for_projects_1.0.unitypackage", Application.dataPath + "/../../downloads/HandMR_iOS_plugin_for_projects_0.x.unitypackage");
